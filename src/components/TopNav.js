...
const TopNav = ({ updateUser, user }) => {
  ...
  return (
    ...
    <div className="navbar-brand-wrapper d-flex justify-content-center" style={{height: "auto"}}>
      <div className="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100"
       style={{height: "auto"}}>
        <a className="navbar-brand brand-logo" href="index.html"><img src="images/redesk.png" alt="logo"
            style={{width:" max-content",height: "auto"}} /></a>
      ...
      <ul className="navbar-nav navbar-nav-right">
        ...
        <li className="nav-item nav-profile dropdown">
          ...
          <div className="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
            ...
            <NavLink to="/login" onClick={()=>updateUser({})} className="dropdown-item">
