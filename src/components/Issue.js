...
const Issue = ({ updateUser, user, useStyles }) => {
  const classes = useStyles();
  // console.log(user.token)
  const {state} = useLocation();
  console.log(state)
  const [projectState, setProjectState]=useState(state.project_id)
  ...
  const getUserList = () => {
    axios.get("/api/userList",{
      ...
      // console.log(error);
      if (error.response.data.status==="422" || error.response.status===401) {
        getTaskList();
        updateUser({});
      }else{
  ...
  return (
    <div>
              ...
              <div className="col-md-12 grid-margin">
                <div className="d-flex justify-content-between flex-wrap">
                  ...
                  <div className="d-flex justify-content-between align-items-end flex-wrap">
                    <button type="button" className="btn btn-light bg-white btn-icon me-3 d-none d-md-block ">
                      <i className="mdi mdi-download text-muted"></i>
                    </button>
                    <button type="button" className="btn btn-light bg-white btn-icon me-3 mt-2 mt-xl-0">
                      <i className="mdi mdi-clock-outline text-muted"></i>
                    </button>
                    <button type="button" className="btn btn-light bg-white btn-icon me-3 mt-2 mt-xl-0">
                      <i className="mdi mdi-plus text-muted"></i>
                    </button>
                    <button onClick={openTask} color="inherit" aria-label="open drawer" edge="start"
                      className="btn btn-primary mt-2 mt-xl-0 text-white" data-toggle="modal"
                  ...
                  <div className="card-body dashboard-tabs p-0">
                    <ul className="nav nav-tabs px-4" role="tablist">
                      <li className="nav-item">
                        <Link className="nav-link active" id="overview-tab" data-bs-toggle="tab" to="#overview" role="tab"
                          aria-controls="overview" aria-selected="true">
                          Open
                        </Link>
                      </li>
                      <li className="nav-item">
                        <Link className="nav-link" id="sales-tab" data-bs-toggle="tab" to="#sales" role="tab"
                          aria-controls="sales" aria-selected="false">
                          Close
                        </Link>
                      </li>
                      <li className="nav-item">
                        <Link className="nav-link" id="purchases-tab" data-bs-toggle="tab" to="#purchases" role="tab"
                    ...
                    <div className="tab-content ">
                      <div className=" row tab-pane fade show active" id="overview" role="tabpanel"
                        ...
                        {taskList
                          ...
                          .map((item, i) => {
                            ...
                            return (
                              <div key={i}>
                              {projectState===item.project_id[0] && <div style={{ cursor: "pointer" }} key={i} onClick={() => editTaskOpen(item)}
                                className="col-md-12 grid-margin "
                              >
                                <div className="card" style={{ borderRadius: "16px" }}>
                                  <div className="card-body dashboard-tabs" style={{ padding: "2.5rem" }}>
                                    
                                      {projectName}
                                    
                                    <div style={{ marginLeft: "22rem", marginTop: "-25px", fontSize: "20px", }}>
                                      {item.task_name}
                                    </div>
                                    <span style={{ marginLeft: "22rem", color: "red", padding: "4px", }}>
                                      BUG
                                    </span>
                                    |
                                    <span style={{ color: "#86A0B7", fontSize: "13px", }}>

                                      {item.task_due_on} added by swagat
                                    </span>
                                    <h4>{item.task_no}</h4>
                                    <span style={{
                                      fontSize: "x-small", color: "#86A0B7", textAlign: "center",
                                      marginLeft: "2px",
                                    }}>
                                      {item.updatedAt}
                                    </span>
                                    <div style={{ marginLeft: "10rem", marginTop: "-37px", }}>
                                      <span style={{
                                        height: "2rem", color: "#45D9D0", backgroundColor: " #45d9d015",
                                        padding: "7px", borderRadius: "2rem",
                                      }}>

                                        {item.task_priority}
                                      </span>
                                    </div>
                                    <p style={{ marginLeft: "22rem", marginTop: "-23px", }}>
                                      {item.task_description}
                                    </p>
                                    <div style={{ marginLeft: "70rem", marginTop: "-45px", }}>
                                      <span style={{
                                        height: "2rem", color: " #45D9D0", backgroundColor: "#45d9d015",
                                        padding: "7px", borderRadius: "2rem",
                                      }}>
                      ...
                      <div className=" row tab-pane fade" id="sales" role="tabpanel" aria-labelledby="sales-tab">
                        {taskList
                          .filter((task) => task.task_labels === "FIXED")
                          .map((item, i) => {
                            // console.log(item)
      ...
      {/* Edit Task Drawer */}
      <Drawer className={classes.drawer} variant="persistent" anchor="right" open={open} classes={{
        paper:
          classes.drawerPaper,
      }}>
        <div className={classes.drawerHeader}>
          <div className="card-header-right">
            <button onClick={editTaskClose} className="collapsed btn btn-sm waves-effect waves-light btn-danger m-0 text-white">
              Close
            </button>
          </div>
        </div>
        <div className="col-md-12 grid-margin stretch-card">
          <div className="card-body">
            ...
            <form className="forms-sample" method="POST">
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-9">
                  <input type="textarea" className="form-control" id="exampleInputprojectDesc" name="task_description"
                    placeholder="Task Desc" onChange={(e) => setTaskDesc(e.target.value)}
                    value={taskDesc}
                    required
                  />
                </div>
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-9">
                  <select className="form-control form-control-lg" name="task_list" onChange={(e) =>
                    setTaskLists(e.target.value)}
                    value={taskLists}
                  >
                    <option defaultValue>Choose Task List</option>
                    <option value="To Do">To Do</option>
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-9">
                  <MultiSelect className="multi-select w-100 " onChange={handleOnchange} name="multiple" options={options}
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-9">
                  <input type="date" className="form-control" id="exampleInputprojectClient" name="task_due_on"
                    placeholder="Task Due On" onChange={(e) => setTaskDue(e.target.value)}
                    value={taskDue}
                    required
                  />
                </div>
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-9">
                  <select className="form-control form-control-lg" name="task_labels" onChange={(e) =>
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-9">
                  <input type="number" className="form-control" id="exampleInputprojectClient" name="task_time_estimation"
                    placeholder="Task Time Estimation" onChange={(e) => setTaskTimeEstimation(e.target.value)}
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-9">
                  <select className="form-control form-control-lg" name="task_priority" onChange={(e) =>
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-9">
                  <input type="file" className="form-control" id="exampleInputprojectTemplate" name="task_attachment"
                    placeholder="Task Attachment" required />
                </div>
              </div>
              <div className="form-group row">
                <label htmlFor="exampleInputprojectCategory" className="col-sm-3 col-form-label">
                ...
                <div className="col-sm-9">
                  <input type="text" className="form-control" id="exampleInputprojectCategory" name="task_subscribers"
                    placeholder="Task List" onChange={(e) => setTaskSubscribers(e.target.value)}
          ...
          */}
              <button onClick={handleEditTask} type="submit" className="btn btn-primary me-2">
                Submit
              </button>
